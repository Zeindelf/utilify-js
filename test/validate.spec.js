...
describe('Validate Methods', () => {
    ...
    it('is empty', (done) => {
        ...
        expect(globalHelpers.isEmpty(date)).to.equal(false);
        ...
        expect(globalHelpers.isEmpty(_null)).to.equal(true);
        ...
        expect(globalHelpers.isEmpty(_undefined)).to.equal(true);

        // More validate
        expect(globalHelpers.isEmpty('')).to.equal(true);
        expect(globalHelpers.isEmpty([])).to.equal(true);
        expect(globalHelpers.isEmpty({})).to.equal(true);
        expect(globalHelpers.isEmpty('foo')).to.equal(false);
        expect(globalHelpers.isEmpty([1, 2])).to.equal(false);
        expect(globalHelpers.isEmpty({a: 'a', b: {c: 'c'}})).to.equal(false);
